        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonTag", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DataEnumCategory",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataEnumCategory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataEnumCategory_DataEnumCategory_ParentId",
                        column: x => x.ParentId,
                        principalTable: "DataEnumCategory",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryDiagnosisText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrimaryCaregiver = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Syndrome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PresentHistory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MedicalInsuranceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientNumberType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloodType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RhBloodType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Height = table.Column<double>(type: "float", nullable: true),
                    Weight = table.Column<double>(type: "float", nullable: true),
                    Marriage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExternalClientNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    WeChatNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdentificationNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BirthDay = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NativeAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Education = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PoliticsStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Occupation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdentificationType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ext2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ext3 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthClient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeNumber = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    EmployeeTitle = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Introduction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Picture = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Goodat = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    StarLevel = table.Column<int>(type: "int", nullable: true),
                    EmployeeTitleType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DefaultSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthEmployee", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityRelation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IdentityRelation_AbpUsers_RelatedUserId",
                        column: x => x.RelatedUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IdentityRelation_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    DataEnumCategoryId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataEnum", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataEnum_DataEnumCategory_DataEnumCategoryId",
                        column: x => x.DataEnumCategoryId,
                        principalTable: "DataEnumCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthAlarm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthAlarm_HealthClient_UserId",
                        column: x => x.UserId,
                        principalTable: "HealthClient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnderLimitValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChartProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    SourceForeId = table.Column<long>(type: "bigint", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthSimpleValueRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthSimpleValueRecord_HealthAlarm_AlarmId",
                        column: x => x.AlarmId,
                        principalTable: "HealthAlarm",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HealthSimpleValueRecord_HealthClient_ClientId",
                        column: x => x.ClientId,
                        principalTable: "HealthClient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataEnum_DataEnumCategoryId",
                table: "DataEnum",
                column: "DataEnumCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DataEnumCategory_ParentId",
                table: "DataEnumCategory",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthAlarm_UserId",
                table: "HealthAlarm",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthSimpleValueRecord_AlarmId",
                table: "HealthSimpleValueRecord",
                column: "AlarmId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthSimpleValueRecord_ClientId",
                table: "HealthSimpleValueRecord",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityRelation_RelatedUserId",
                table: "IdentityRelation",
                column: "RelatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityRelation_UserId",
                table: "IdentityRelation",
                column: "UserId");
