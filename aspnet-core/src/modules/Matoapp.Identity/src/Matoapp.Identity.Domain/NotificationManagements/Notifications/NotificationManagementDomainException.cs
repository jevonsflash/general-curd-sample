...
namespace Matoapp.Identity.NotificationManagements.Notifications
{
    ...
    {
        public NotificationManagementDomainException(string message, string code = null, string details = null, Exception innerException = null, LogLevel logLevel = LogLevel.Warning)
